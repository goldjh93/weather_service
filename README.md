...
- `api/index.py`: Vercel이 감지하는 Python Serverless Function 엔트리포인트
- `api/weather.py`: 날씨 API 처리 로직
...
GitHub 저장소와 Vercel 프로젝트를 연결했다면, 이 폴더를 push하면 Vercel이 자동으로 `index.html`과 `api/index.py`를 배포합니다.
